...
在飞: 只认 STATE-NOW 三行（禁止凭记忆）· 现 #748
...
**Current snapshot:** [`docs/STATE-NOW.md`](docs/STATE-NOW.md) — **唯一现况**（三行 · 在飞 #748 · #634）。下面目录不当现况。  
...
**Current dispatch:** [`docs/STATE-NOW.md`](docs/STATE-NOW.md) · 在飞 **#748**。`DAY-TASK-*` / #310 / #627 / 已关 #646 **不当现况**。   
