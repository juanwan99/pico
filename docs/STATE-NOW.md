...
live: curl -fsS https://pico.aivia.asia/api/pico/tip
      → 必须 = origin/main
阻塞: #794 合部完 · 五句已贴 · 过门未点 · #748 合部完不关 · 记忆 OS 挂
────────────────────────────────────
CLAIM-WB-DEGREE-WEB: YES（业主 2026-08-26 · #449/#316 OWNER DECISION @ 本 tip）
PRODUCT PASS: #682/#684/#686/#690/#694/#697 业主已签 · #701 夜间/来源条业主 pass · #703/#706/#707/#708/#709/#710 业主 PASS 收口 · #449/#316 勿关 · #733 夜包业主 PASS @ tip `a6bc83df…` · #752 业主 PASS @ tip `0c7943ac…` · #740 业主 PASS @ tip `2e668686…` · #776 业主 PASS @ tip `812360f6…` · #780 业主 PASS @ tip `e9e032b3…` · #785 业主 PASS @ tip `9d14329c…` · 记忆 OS 仍挂起
...
7. **自循环。** 总线=合同 Issue（`## 派发`/`CANDIDATE`/`DEPLOYED`/五句）。起窗=`spawn-executor`（SSH ecs grok）。贴派发当场 spawn；只贴不 spawn=没派。活窗禁再 spawn。无 ssh-ecs 拒领。禁 `@cursor` / Cloud Agent 当执行者。订约读回执；不合不部；合了未部关卡打回。禁 mailbox / 第二账本。

失真 = 证据 PR / 合了报 DONE / 过门写控件 / 拆 PR / 凭聊天当真源 / 只贴不 spawn / tip-pin 当 CLEAR。总管打回。
...
| 已收口 | [#788](https://github.com/juanwan99/pico/issues/788) | T-POINTS-FACE · 业主 PASS · 已关 |
| 合部完 | [#794](https://github.com/juanwan99/pico/issues/794) · [#795](https://github.com/juanwan99/pico/pull/795) | T-SUB2API-FACE · DEPLOYED+五句 · 过门未点 · 不关卡 |
