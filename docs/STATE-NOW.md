...
── 现况三行（开窗先对；禁止凭记忆）──
在飞: #682 T-KB-ENGINE-ON（A1 · stamp-ok · OPEN · #683 MERGED 未部）
live: curl -fsS https://pico.aivia.asia/api/pico/tip
      → 363f1638ac8680900f8ff816fce6f0fa35a05d53 ≠ main `590772fe…`
阻塞: 合了未部 · 等执行窗 prod-update · 总管不部
────────────────────────────────────
...
| 优先级 | Issue | 说明 |
|--------|-------|------|
| 在飞 | [#682](https://github.com/juanwan99/pico/issues/682) | A1 · [#683](https://github.com/juanwan99/pico/pull/683) MERGED `590772fe` · tip 未对齐 · 等部 |
