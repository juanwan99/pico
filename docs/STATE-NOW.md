...
live: curl -fsS https://pico.aivia.asia/api/pico/tip
      → 必须 = origin/main（现网已对齐 · #733 夜包 tip）
阻塞: 无
────────────────────────────────────
CLAIM-WB-DEGREE-WEB: YES（业主 2026-08-26 · #449/#316 OWNER DECISION @ 本 tip）
PRODUCT PASS: #682/#684/#686/#690/#694/#697 业主已签 · #701 夜间/来源条业主 pass · #703/#706/#707/#708/#709/#710 业主 PASS 收口 · #449/#316 勿关 · #733 夜包工程完（瘦常驻/hybrid/人视角薄层）· 记忆 OS 仍挂起 · 等业主 PASS
...
| 已收口 | [#733](https://github.com/juanwan99/pico/issues/733) | T-NIGHT-CORE-3 · 工程部完 tip `b521a1d8…` · 等业主 PASS |
