# Visual gate · pack-triple-100-night / p10-c2-multifile
...
| 项 | 值 |
|----|-----|
| tip | `c6186d2dcf5c5ec27a4589112a0cb0ff2cc3409c` |
| base | https://pico.aivia.asia |
| conversation | https://pico.aivia.asia/c/7e071d94-93b1-49ce-a6a0-7104b6f5ad75 |
| frames complete | Y |
| monologue clean (heuristic) | Y |
| scene visual pass eligible | Y |
