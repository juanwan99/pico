...
function Conversation({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'group relative flex min-h-12 w-full items-start rounded-lg py-1.5 outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-black dark:focus-visible:ring-white md:min-h-9',
