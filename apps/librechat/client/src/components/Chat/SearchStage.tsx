...
export default function SearchStage({ children }: { children?: ReactNode }) {
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[720px] shrink-0 px-6 pb-4 pt-10">
        ...
        <div className="mt-5 rounded-xl border border-[color:var(--pico-line)] bg-[color:var(--pico-surface)] px-1">
          <SearchBar autoFocus />
        </div>
      </div>
