...
const en: LocaleType = {
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Pico AI workspace: Instantly unlock the latest models like OpenAI o1, GPT-4o, Claude-3.5!",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        Label: " (self-hosted)",
        SubTitle:
          "Runs through Pico server orchestration and AI ledger. Keys stay server-side.",
        ChatNow: "Open settings",
      },
      AccessCode: {
        Title: "Access Code",
