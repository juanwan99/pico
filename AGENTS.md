...
Owner-aligned goals: [`docs/DIRECTION-NOW.md`](docs/DIRECTION-NOW.md) §0-star + [`docs/TRUTH-FREEZE.md`](docs/TRUTH-FREEZE.md) v1.8。[`docs/CORRECTED-GOALS.md`](docs/CORRECTED-GOALS.md) = 考古，文中 Kimi 优先句已废，**勿当当前目标**。
