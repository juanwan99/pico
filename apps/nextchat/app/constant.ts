export const OWNER = "juanwan99";
export const REPO = "pico";
export const REPO_URL = `https://github.com/${OWNER}/${REPO}`;
export const PLUGINS_REPO_URL = `https://github.com/${OWNER}/${REPO}`;
...
export const STORAGE_KEY = "pico-ai-workspace";
...
export const SAAS_CHAT_URL = "/#/settings";
export const SAAS_CHAT_UTM_URL = "/#/settings";
